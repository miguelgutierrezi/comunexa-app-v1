...
**Estado app (2026-08-25):** bootstrap + **`supabase_flutter`** (`ComunexaSupabase`) + tema + splash + login UI + home shell mock. Auth sigue stub (bypass); sin `go_router` ni home por rol real. Detalle en el roadmap Fase 2.
