...
**Estado (2026-08-25):** fundamentos + UI login/splash/home + **migración 003 acceso** (org/property/memberships). Cutover legacy + Auth Supabase / go_router pendientes. Ver [`docs/roadmap.md`](docs/roadmap.md).
