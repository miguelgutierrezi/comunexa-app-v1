...
**Estado (2026-08-25):** fundamentos + UI login + **home shell mock** + **añadir noticia** (móvil / tablet port+land / desktop · light+dark). Auth Supabase / go_router pendientes. Ver [`docs/roadmap.md`](docs/roadmap.md).
