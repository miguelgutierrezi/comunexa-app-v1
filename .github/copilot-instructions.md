...
- Done: migrations + RLS, Flutter bootstrap, theme/branding, splash, **responsive login UI**, **home shell mock**, **añadir noticia** (móvil / tablet port+land / desktop · light+dark), GHA workflows, remote GitHub.
